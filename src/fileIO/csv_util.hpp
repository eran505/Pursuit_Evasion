...
#ifndef PE_CSV_UTIL_HPP
#define PE_CSV_UTIL_HPP
...
public:
    ...
    explicit csvfile(const std::string& filename, std::string  separator = ";",bool isApp= false)
            : fs_()
            , is_first_(true)
            ...
            , special_chars_("\"")
    {
        ...
        fs_.open(filename, std::ios_base::app | ios_base::out);
    }
